...
urlpatterns = [
    ...
    path('latest_news/',views.latest_news_view,name="latest_news"),
    ...
    path('horoscope/chineese/<value>',views.lifestyle_horoscope_chineese_inside_view,name="chineese_horoscope_inside"),
    path('horoscope/<value>',views.lifestyle_horoscope_inside_view,name="horoscope_inside"),
